...
{
	if(valor_sorteado >= 1 && valor_sorteado <= 5)
	    {
		*ptrTar = *ptrTar + 3;
	    }
	else if(valor_sorteado > 5 && valor_sorteado <= 7)
	    {
		*ptrTar = *ptrTar - 1;
		if( *ptrTar < 0)
		{
...
{ 
	...
	else if(valor_sorteado > 2 && valor_sorteado <= 4)
    {
		(*ptrLeb) += 9;
    }
	...
	else if(valor_sorteado > 5 && valor_sorteado <= 8)
	{
	        (*ptrLeb) += 1;
	}
	else
